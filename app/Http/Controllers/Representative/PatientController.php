...
class PatientController extends Controller
{
        ...
        $query = Patient::where('representative_id', $representative->id)
            ->where(function ($q) {
                $q->whereNull('lead_status')
                  ->orWhereNotIn('lead_status', ['new', 'assigned', 'contacted', 'negotiating']);
            });
    ...
    public function create()
    {
        ...
        $countryCodes = [
            ...
            ['code' => '+7', 'country' => 'Kazakhstan'], // Shared with Russia
        ...
        return view('representative.patients.create', compact('representative', 'countryCodes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Patient::create([
            ...
            'notes' => $request->notes,
            'lead_status' => 'converted', // Ensure it appears in My Patients, not Leads
        ]);
