        ...
        <form action="{{ route('representative.orders.update', $order) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="col-span-2 md:col-span-1">
                     ...
                     <input type="text" value="{{ $order->patient->name }}" disabled class="block w-full mt-1 bg-gray-100 border-gray-300 rounded-md cursor-not-allowed">
                     <p class="text-xs text-gray-500 mt-1">Patient cannot be changed.</p>
                </div>
            ...
            <div class="flex justify-end mt-6 gap-4">
                <a href="{{ route('representative.orders.index') }}" class="px-4 py-2 text-sm text-gray-600 bg-gray-200 rounded-lg hover:bg-gray-300">Cancel</a>
