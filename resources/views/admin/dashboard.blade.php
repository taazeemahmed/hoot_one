    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            <div class="flex items-start justify-between mb-3">
                ...
                <span class="text-xs font-semibold px-2 py-1 rounded-full {{ $kpis['patients_growth'] > 0 ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600' }}">
        ...
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <div class="mt-2 w-full bg-gray-100 rounded-full h-1.5">
                <div class="bg-green-500 h-1.5 rounded-full transition-all" style="width: {{ min($kpis['conversion_rate'], 100) }}%"></div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            <div class="flex items-start justify-between mb-3">
                ...
                <span class="text-xs font-semibold px-2 py-1 rounded-full {{ $kpis['orders_growth'] > 0 ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600' }}">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="divide-y divide-gray-50 max-h-[420px] overflow-y-auto">
                    ...
                    <div class="px-5 py-12 text-center">
                        <div class="inline-flex items-center justify-center w-12 h-12 mb-3 bg-green-50 rounded-full text-green-500">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="flex items-center gap-1.5 text-xs {{ $whatsappStats['failed_week'] > 5 ? 'text-amber-600' : 'text-green-600' }}">
                        <span class="w-1.5 h-1.5 rounded-full {{ $whatsappStats['failed_week'] > 5 ? 'bg-amber-500' : 'bg-green-500' }}"></span>
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors renewal-row" data-urgency="{{ $order->urgency }}">
                        ...
                        <td class="px-5 py-3">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <a href="tel:{{ $order->patient->phone }}" class="p-1.5 rounded-lg text-gray-400 hover:text-green-600 hover:bg-green-50 transition-all" title="Call">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                                    </svg>
                                </a>
                ...
                <div class="px-5 py-3 hover:bg-gray-50/50 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            <div class="text-sm font-semibold {{ $rep['conversion_rate'] >= 25 ? 'text-green-600' : ($rep['conversion_rate'] >= 15 ? 'text-amber-600' : 'text-gray-600') }}">
                                {{ $rep['conversion_rate'] }}%
                            </div>
                    ...
                    <div class="mt-2 w-full bg-gray-100 rounded-full h-1">
                        <div class="h-1 rounded-full transition-all {{ $rep['conversion_rate'] >= 25 ? 'bg-green-500' : ($rep['conversion_rate'] >= 15 ? 'bg-amber-500' : 'bg-gray-400') }}" 
            ...
            <div class="p-5">
                <div class="space-y-3">
                    @php
                        ...
                        $colors = ['bg-blue-500', 'bg-green-500', 'bg-purple-500', 'bg-amber-500', 'bg-pink-500', 'bg-indigo-500', 'bg-teal-500', 'bg-orange-500'];
                    @endphp
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <div class="flex items-center gap-3 text-xs">
                                ...
                                <span class="font-semibold {{ $country->conversion_rate >= 25 ? 'text-green-600' : 'text-gray-600' }}">{{ $country->conversion_rate }}%</span>
                            </div>
                        </div>
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-5 py-3 text-center">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold 
                                {{ $member['conversion_rate'] >= 25 ? 'bg-green-100 text-green-700' : ($member['conversion_rate'] >= 15 ? 'bg-amber-100 text-amber-700' : 'bg-gray-100 text-gray-600') }}">
